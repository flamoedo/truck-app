  ...
  <v-content>
    <div id="AppTR" style="max-width: 400px; margin: auto;">
      ...
      <div v-if="posts.length > 0">
        <v-row>
          <v-col v-for="post in posts" :key="post.cacheId">
            <v-card>
...
export default {
  ...
  methods: {
    ...
    getData(pagina) {
      fetch(
        `https://www.googleapis.com/customsearch/v1?q=${this.search}&cx=007949313772641196886%3Aumrnh2lgtmc&key=AIzaSyDngYaB8_hSw79gLsOUaQyG0BhD7V9Zh1Y&start=${pagina}`
      )
